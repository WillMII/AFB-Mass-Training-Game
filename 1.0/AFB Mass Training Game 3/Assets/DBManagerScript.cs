...
public class DBManagerScript : MonoBehaviour
{
    ...
    public void callLoadInData()
    {
        ...
        int[] testMultiPartClueArray = new int[3];
    ...
    IEnumerator loadInData()
    {
        ...
        UnityWebRequest www = UnityWebRequest.Post("http://localhost:8001/phpfiles/recordsget.php", form);
    ...
    IEnumerator saveData()
    {
        ...
        form.AddField("clue2completed", DBManager.multipartCluesCompleted[0]);
        form.AddField("clue3clicked", DBManager.cluesClicked[2]);
        form.AddField("clue4clicked", DBManager.cluesClicked[3]);
        form.AddField("clue4completed", DBManager.multipartCluesCompleted[1]);
        ...
        form.AddField("clue8completed", DBManager.multipartCluesCompleted[2]);
        form.AddField("quizcompleted", DBManager.quizCompleted);
        //form.AddField("quizCompleted", DBManager.quizCompleted);

        UnityWebRequest www = UnityWebRequest.Post("http://localhost:8001/phpfiles/recordsset.php", form);
        yield return www.SendWebRequest();
        if (www.downloadHandler.text[0] == '0')
        {
        ...
        UnityWebRequest progressWWW = UnityWebRequest.Post("http://localhost:8001/phpfiles/recordsprogress.php", progressForm);
